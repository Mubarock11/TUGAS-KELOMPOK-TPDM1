...
if ($_GET[module]=='home'){
echo "<div style='width:100%; text-align:center;font-weight:bold;padding:7px; background:#e3e3e3; margin-bottom:20px;'>Selamat datang Di aplikasi data Mining - Metode Clustering Algoritma K-Means</div>
...
elseif ($_GET[module]=='profile'){
	echo "<div style='width:100%; text-align:center;font-weight:bold;padding:7px; background:#e3e3e3; margin-bottom:20px;'>Profile Perusahaan -  K- MEANS</div>
	<p>Data mining adalah suatu metode pengolahan data untuk menemukan pola
yang tersembunyi dari data tersebut. Hasil dari pengolahan data dengan metode data
mining ini dapat digunakan untuk mengambil keputusan di masa depan. Data mining
ini juga dikenal dengan istilah pattern recognition (Santosa, 2007).
